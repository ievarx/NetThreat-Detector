...
class App(QWidget):
    def __init__(self):
        ...
        self.update_timer.start(1000)  # Update table every 1 second
    ...
    def init_db(self):
        ...
        self.conn = sqlite3.connect('packets.db', check_same_thread=False)  # Fixed database file
    ...
    def save_to_database(self):
        # Save the current data to the fixed database in a separate thread
